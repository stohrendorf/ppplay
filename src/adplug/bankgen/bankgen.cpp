...
int main(int argc, char** argv)
{
  ...
  db.loadMiles( "opl_files/file17.opl",
  ...
  db.loadMiles( "opl_files/file20.opl",
  ...
  db.loadBnk2( "bnk_files/file159.bnk",
