...
void CxadflashPlayer::xadplayer_update() {
  unsigned short event_pos =
      (tune[0x600 + flash.order_pos] * 1152) + (flash.pattern_pos * 18) + 0x633;
...
float CxadflashPlayer::xadplayer_getrefresh() { return 17.5f; }

std::string CxadflashPlayer::xadplayer_gettype() {
  return std::string("xad: flash player");
}

unsigned int CxadflashPlayer::xadplayer_getinstruments() { return 32; }
