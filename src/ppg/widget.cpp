...
int Rect::top() const { return m_topLeft.y(); }
void Rect::setTop(int top) { m_topLeft.setY(top); }
int Rect::left() const { return m_topLeft.x(); }
void Rect::setLeft(int left) { m_topLeft.setX(left); }
int Rect::bottom() const { return m_bottomRight.y(); }
void Rect::setBottom(int bottom) { m_bottomRight.setY(bottom); }
int Rect::right() const { return m_bottomRight.x(); }
void Rect::setRight(int right) { m_bottomRight.setX(right); }
int Rect::width() const { return m_bottomRight.x() - m_topLeft.x() + 1; }
void Rect::setWidth(int width) { m_bottomRight.setX( m_topLeft.x() + width - 1 ); }
int Rect::height() const { return m_bottomRight.y() - m_topLeft.y() + 1; }
void Rect::setHeight(int height) { m_bottomRight.setY( m_topLeft.y() + height - 1 ); }
Point Rect::topLeft() const { return m_topLeft; }
Point& Rect::topLeft() { return m_topLeft; }
Point Rect::bottomRight() const { return m_bottomRight; }
Point& Rect::bottomRight() { return m_bottomRight; }
