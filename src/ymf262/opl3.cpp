...
Opl3::Opl3()
    : m_registers(), m_operators(), m_channels2op(), m_channels4op(), m_channels(), m_disabledChannel()
{
    ...
    for( int array = 0; array < 2; array++ )
    {
        for( int channelNumber = 0; channelNumber < 3; channelNumber++ )
        {
            ...
            m_channels2op[array][channelNumber].reset(
                new Channel(this, baseAddress, m_operators[array][channelNumber].get(), m_operators[array][channelNumber + 0x3].get()));
            // Channels 4, 5, 6 -> Operator offsets 0x8,0xB; 0x9,0xC; 0xA,0xD
            m_channels2op[array][channelNumber + 3].reset(
                new Channel(this, baseAddress + 3, m_operators[array][channelNumber + 0x8].get(), m_operators[array][channelNumber + 0xB].get()));
            // Channels 7, 8, 9 -> Operators 0x10,0x13; 0x11,0x14; 0x12,0x15
            m_channels2op[array][channelNumber + 6].reset(
                new Channel(this, baseAddress + 6, m_operators[array][channelNumber + 0x10].get(), m_operators[array][channelNumber + 0x13].get()));
        }
    }
    for( int array = 0; array < 2; array++ )
    {
        for( int channelNumber = 0; channelNumber < 3; channelNumber++ )
        {
            ...
            m_channels4op[array][channelNumber].reset(
                new Channel(this, baseAddress, m_operators[array][channelNumber].get(), m_operators[array][channelNumber + 0x3].get(),
                            m_operators[array][channelNumber + 0x8].get(), m_operators[array][channelNumber + 0xB].get()));
        }
    }
