...
std::string XmChannel::effectDescription() const throw(PppException)
{
    return m_fxString;
}

std::string XmChannel::effectName() const throw(PppException)
{
	return m_currentCell.fxString();
}

std::string XmChannel::noteName() throw(PppException)
{
	if(m_baseNote == 0) {
		return "...";
	}
